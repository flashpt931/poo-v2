...
public class Projeto_civ_1 {
    ...
    public void iniciar() {
        ...
        boolean sair = false;
        while (!sair) {
            System.out.println("=== Civilização - Turno " + turno + " ===");
    ...
    private void gerirCidade(Scanner scanner) {
        ...
        if (cidade != null) {
            ...
            while (!voltar) {
                System.out.println("Gerindo cidade na posição (" + cidade.getX() + ", " + cidade.getY() + ")");
                System.out.println("Nível da cidade: " + cidade.getNivel());
                System.out.println("Recursos: " + cidade.getComida() + " comida, " + cidade.getProducao() + " produção, " + cidade.getOuro() + " ouro");
    ...
    private void gerirEdificios(Scanner scanner, Cidades cidade) {
        boolean voltar = false;
        while (!voltar) {
            System.out.println("1. Listar Edifícios");
            System.out.println("2. Construir Serralheria (3 turnos, 10 produção)");
            System.out.println("3. Construir Talho (3 turnos, 10 produção)");
            System.out.println("4. Construir Mina (5 turnos, 10 produção)");
            System.out.println("5. Voltar");
            System.out.print("Escolha uma opção: ");
            int opcao = scanner.nextInt();
            switch (opcao) {
